...
@ComponentScan(basePackages = "br.com.softblue.bluefoot.infrastructure.web.controller")
public class PublicController {
	...
	public String saveRestaurante(
		...
		ControllerHelper.setEditMode(model, false);
		ControllerHelper.addCategoriasToRequest(categoriaRestauranteRepository, model);//recarrega categorias
		return "restaurante-cadastro";
	}
