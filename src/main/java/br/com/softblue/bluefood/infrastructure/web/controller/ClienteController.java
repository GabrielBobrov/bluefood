...
public class ClienteController {
	...
	public String viewRestaurante(@RequestParam("restauranteId") Integer restauranteId, 
		...
		if(categoria == null) {
			...
			itensCardapioDestaque = itemCardapioRepository.findByRestaurante_IdAndDestaqueOrderByNome(restauranteId,
					true);
			

			itensCardapioNaoDestaque = itemCardapioRepository.findByRestaurante_IdAndDestaqueOrderByNome(restauranteId,
					false);
